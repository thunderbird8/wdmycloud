...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		...
		//	if( o.script == undefined ) o.script = 'jqueryFileTree.php';
			...
			/* [+] for ftp command, Add by Amy */
			if (o.host == undefined) o.host = ""; 
			if (o.user == undefined) o.user = "";
			if (o.pwd == undefined) o.pwd = "";			
			/* [-] for ftp command, Add by Amy */
			if (o.lang == undefined) o.lang = "";	/* [+] for ftp command, Add by Eve */
...
//								}
					...
					$.post(o.script, { dir: unescape(t), cmd: o.cmd, show_file: __file ,chk_flag:__chkflag,file_type:o.filetype,function_id:o.function_id,filter_file:o.filter,root_path:o.root_path, host: o.host, user:o.user, pwd:o.pwd, lang:o.lang}, function(data) {
						...
						/* for ftp connect fail case by Amy++*/
						if (o.function_id == "FDownload")
						{
							var my_html = $(data).html();
							//var res = (typeof(my_html) == "undefined")?430:parseInt(my_html,10);
							var res = parseInt(my_html,10);
							var msg = "";
							
							switch(res)
							{
								case 550:
									msg = _T('_ftp_downloads','status_550');
								break;
								
								case 451:
									msg = _T('_ftp_downloads','status_451');
								break;
								
								case 430:
									msg = _T('_ftp_downloads','status_430');
								break;
								
								case 10061:
									msg = _T('_ftp_downloads','status_10061');
								break;
								
								case 10064:
									msg = _T('_ftp_downloads','status_10064');
								break;
								
								case 11001:
									msg = _T('_ftp_downloads','status_11001');
								break;
								
								case 10060:
									msg = _T('_ftp_downloads','status_10060');
								break;
											
								case 10057:
									msg = _T('_ftp_downloads','status_10057');
								break;			
